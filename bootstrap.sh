...
# One-liner: curl -fsSL https://raw.githubusercontent.com/acester822/vscode-dark-islands/main/bootstrap.sh | bash

echo "🏝️  Islands Dark Theme Bootstrap Installer"
echo "=========================================="
echo ""

REPO_URL="https://github.com/acester822/vscode-dark-islands.git"
